...
// so the section stays hidden if this file is ever reached outside a dev
// server (e.g. the static index.html deployed to GitHub Pages).
import { createRoot } from "react-dom/client";
import { TetrWidget } from "./TetrWidget";
import "./Tetr.module.css";

if (import.meta.env.DEV) {
  document.getElementById("dev-live-section")!.style.display = "";
  createRoot(document.getElementById("root")!).render(<TetrWidget />);
}
